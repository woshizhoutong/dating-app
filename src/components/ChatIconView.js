...
export default class ChatIconView extends Component {
  static propTypes = {
        ...
        {this.props.participants.length > 1 && (
          <TouchableOpacity
            ...
            <FastImage
              ...
              source={{ uri: this.props.participants[0].profilePictureURL }}/>
            <View style={styles.middleIcon} />
            <FastImage
              style={[styles.multiPaticipationIcon, styles.topIcon]}
              source={{ uri: this.props.participants[1].profilePictureURL }}/>
          </TouchableOpacity>
        )}
      </View>
    );
